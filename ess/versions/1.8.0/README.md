...
This version of ESS adds the `dictionaryFromJson` sync type, which fetches a JSON object and flattens it into a dictionary secret. It also fixes a bug preventing the cleanup from running.
