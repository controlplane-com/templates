...
**Fixed in 1.2.0.** Versions through 1.1.x shipped `ttl: 30`, `loopWait: 10`, `retryTimeout: 30` —
...
is never consulted again. Installing 1.2.0 fixes new clusters only. To fix a running one, set all three
