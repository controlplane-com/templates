...
cpln workload exec RELEASE_NAME-timescaledb-ha --gvc GVC_NAME --container patroni-timescaledb \
...
**1.2.0 corrects a defect here.** Versions through 1.1.x shipped `ttl: 30` alongside `retry_timeout: 30`,
